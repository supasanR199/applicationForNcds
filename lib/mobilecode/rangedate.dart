              ...
              Card(
                child: Column(
                  children: [
                    ...
                    Text(
                      "ประวัติบันทึกการรับประทานอาหารแต่ละวัน",
                      style: TextStyle(
                          // fontSize: 25,
                          // fontWeight: FontWeight.bold,
                          ),
                          ...
                          DoughnutSeries<ValueData, String>(
                            dataSource: [
                              ValueData('อาหารหวาน', data.Allfood[0],
                                  "${percent(data.Allfood[0], data.Allfood.sum).toStringAsFixed(1)} %"),
                              ValueData('อาหารมัน', data.Allfood[1],
                                  "${percent(data.Allfood[1], data.Allfood.sum).toStringAsFixed(1)} %"),
                              ValueData('อาหารเค็ม', data.Allfood[2],
                                  "${percent(data.Allfood[2], data.Allfood.sum).toStringAsFixed(1)} %"),
                            ],
                                                                    ...
                                                                    children: [
                                                                      SfDateRangePicker(
                                                                        ...
                                                                        onSubmit:
                                                                          ...
                                                                          print(
                                                                              "มีการบันทึกข้อมูล ${data.totalday}");
                                                                          Navigator.pop(
                                                                              context);
                                                                        },
                                                                        onCancel:
                        ...
                        if (data.totalday > 0) ...[
                          Column(
                            children: [
                              ...
                              Text(
                                  "จำนวนวันที่มีการบันทีก ${data.totalday} วัน"),
                              const SizedBox(
                                height: 10,
                              ),
                            ],
                        ...
                        ColumnSeries<SweetData, String>(
                            dataSource: [
                              SweetData(
                                  ...
                                  "${data.sweetchoice1} วัน"),
                              SweetData(
                                  'ข้อ2',
                                  data.sweetchoice2,
                                  Colors.pink.shade400,
                                  "${data.sweetchoice2} วัน"),
                              SweetData(
                                  'ข้อ3',
                                  data.sweetchoice3,
                                  Colors.pink.shade400,
                                  "${data.sweetchoice3} วัน"),
                              SweetData(
                                  'ข้อ4',
                                  data.sweetchoice4,
                                  Colors.pink.shade400,
                                  "${data.sweetchoice4} วัน"),
                              SweetData(
                                  'ข้อ5',
                                  data.sweetchoice5,
                                  Colors.pink.shade400,
                                  "${data.sweetchoice5} วัน"),
                            ],
                          ...
                          if (data.totalday > 0) ...[
                            Column(
                              ...
                              children: [
                                ...
                                ListTile(
                                  leading: Text(
                                    'ข้อ1  รับประทาน น้ำเปล่า เครื่องดื่มไม่ผสมน้ำตาล :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.sweetchoice1}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ2  รับประทาน น้ำอัดลม เครื่องดื่มชง น้ำหวาน นมเปรี้ยว :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.sweetchoice2}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ3  รับประทาน น้ำผักผลไม้สำเร็จรูป :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.sweetchoice3}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ4  รับประทาน ไอศกรีม เบเกอรี่ หรือขนมไทย :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.sweetchoice4}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ5  รับประทาน เติมน้ำตาล น้ำผึ้ง น้ำเชือมเพิ่มในอาหาร :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.sweetchoice5}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                        ...
                        if (data.totalday > 0) ...[
                          Column(
                            ...
                            children: [
                              ...
                              ListTile(
                                leading: Text(
                                  'ข้อ1  เนื้อติดมัน ติดหนัง :',
                                  style: TextStyle(
                                    fontSize: 17,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                trailing: Text("${data.fatchoice1}",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                              ),
                              ListTile(
                                leading: Text(
                                  'ข้อ2  อาหารทอด ฟาสฟู๊ด ผัดน้ำมัน :',
                                  style: TextStyle(
                                    fontSize: 17,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                trailing: Text("${data.fatchoice2}",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                              ),
                              ListTile(
                                leading: Text(
                                  'ข้อ3  อาหารจานเดียวไขมันสูง หรือแกงกะทิ :',
                                  style: TextStyle(
                                    fontSize: 17,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                trailing: Text("${data.fatchoice3}",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                              ),
                              ListTile(
                                leading: Text(
                                  'ข้อ4  เครื่องดื่มผสม นมข้นหวาน ครีมเทียม วิปปิ้งครีม :',
                                  style: TextStyle(
                                    fontSize: 17,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                trailing: Text("${data.fatchoice4}",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                              ),
                              ListTile(
                                leading: Text(
                                  'ข้อ5  ซดน้ำผัด น้ำแกง หรือราดลงในข้าว :',
                                  style: TextStyle(
                                    fontSize: 17,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                trailing: Text("${data.fatchoice5}",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                              ),
                        ...
                        ColumnSeries<SaltData, String>(
                            dataSource: [
                              SaltData(
                                  ...
                                  data.saltchoice1,
                                  Colors.blue.shade400,
                                  "${data.saltchoice1} วัน"),
                              SaltData(
                                  'ข้อ2',
                                  data.saltchoice2,
                                  Colors.blue.shade400,
                                  "${data.saltchoice2} วัน"),
                              SaltData(
                                  'ข้อ3',
                                  data.saltchoice3,
                                  Colors.blue.shade400,
                                  "${data.saltchoice3} วัน"),
                              SaltData(
                                  'ข้อ4',
                                  data.saltchoice4,
                                  Colors.blue.shade400,
                                  "${data.saltchoice4} วัน"),
                              SaltData(
                                  'ข้อ5',
                                  data.saltchoice5,
                                  Colors.blue.shade400,
                                  "${data.saltchoice5} วัน"),
                            ],
                          ...
                          if (data.totalday > 0) ...[
                            Column(
                              ...
                              children: [
                                ...
                                ListTile(
                                  leading: Text(
                                    'ข้อ1  ชิมอาหารก่อนปรุง ปรุงน้อยหรือไม่ปรุงเพิ่ม :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.saltchoice1}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ2  ใช้สมุนไพรหรือเครื่องเทศแทนเครื่องปรุง :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.saltchoice2}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ3  เนื้อสัตว์แปรรูป :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.saltchoice3}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  ...
                                  trailing: Text("${data.saltchoice4}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
                                ListTile(
                                  leading: Text(
                                    'ข้อ5  ผักผลไม้ของดอง หรือ ผลไม้จิ้มพริกเกลือ น้ำปลาหวาน :',
                                    style: TextStyle(
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                  trailing: Text("${data.saltchoice5}",
                                      style: TextStyle(
                                        fontSize: 17,
                                      )),
                                ),
