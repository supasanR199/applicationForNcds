                            ...
                            DoughnutSeries<ValueData, String>(
                              dataSource: [
                                ValueData(
                                    'เครียดน้อยหรือ\nไม่เครียดเลย',
                                    data.Totalmood[0],
                                    "${percent(data.Totalmood[0], data.totalday).toStringAsFixed(1)} %"),
                                ValueData('เครียดปานกลาง', data.Totalmood[1],
                                    "${percent(data.Totalmood[1], data.totalday).toStringAsFixed(1)} %"),
                                ValueData('เครียดมาก', data.Totalmood[2],
                                    "${percent(data.Totalmood[2], data.totalday).toStringAsFixed(1)} %"),
                                ValueData('เครียดมากที่สุด', data.Totalmood[3],
                                    "${percent(data.Totalmood[3], data.totalday).toStringAsFixed(1)} %"),
                              ],
                              xValueMapper: (ValueData data, _) =>
                                  data.continentAllFood,
                              yValueMapper: (ValueData data, _) => data.value,
                              dataLabelMapper: (ValueData data, _) =>
                                  data.label,
                                                                  ...
                                                                  body:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onSubmit:
                                                                        ...
                                                                        setState(
                                                                            () {
                                                                          var StartDate = DateTime.parse(_datePickerController
                                                                              .selectedRange
                                                                              .startDate
                                                                              .toString());
                                                                          if (_datePickerController.selectedRange?.endDate ==
                                                                              null) {
                                                                            EndDate =
                                                                                DateTime.parse(_datePickerController.selectedRange.startDate.toString());
                                                                          } else {
                                                                            EndDate =
                                                                                DateTime.parse(_datePickerController.selectedRange.endDate.toString());
                                                                          }
                                                                          ...
                                                                          // }
                                                                          data.Difference =
                                                                              num.parse(StartDate.difference(EndDate).inDays.toString()).abs();
                                                                          data.StartDate =
                                                                        ...
                                                                        for (var i =
                                                                          ...
                                                                          for (var c = 0;
                                                                              c <= data.Difference;
                                                                              c++) {
                                                                            //นำส่วนต่างมากำหนดลูป
                                                                            var NowDate =
                                                                                DateFormat('yyyy-MM-dd').format(DateTime.parse("${data.EndDate}").subtract(Duration(days: c))).toString(); //เริ่มนับถอยหลัง
                                                                            print("## ${NowDate}");
                                                                            if (dairyModel[i].date == NowDate &&
                                                                                dairyModel[i].Totalmood != "null") {
                                                                              //ถ้าถอยหลังแล้วเจอ
                    ...
                    children: [
                      ...
                      Column(children: [
                        if (data.totalday > 0) ...[
                          ...
                          Text(
                              "จากการเลือกวันที่ ${DateThai(data.StartDate)} ถึงวันที่ ${DateThai(data.EndDate)}"),
                        ...
                        series: <ChartSeries>[
                          ColumnSeries<EmotionSleepData, String>(
                              ...
                              xValueMapper: (EmotionSleepData val, _) =>
                                  val.continent,
                              yValueMapper: (EmotionSleepData val, _) =>
                                  val.val,
                              dataLabelMapper: (EmotionSleepData data, _) =>
                                  data.label,
                              dataLabelSettings:
                                  DataLabelSettings(isVisible: true),
                              pointColorMapper: (EmotionSleepData data, _) =>
                                  data.color,
                              enableTooltip: false)
                        ],
                        ...
                        series: <ChartSeries>[
                          ColumnSeries<EmotionMeditateData, String>(
                              ...
                              xValueMapper: (EmotionMeditateData val, _) =>
                                  val.continent,
                              yValueMapper: (EmotionMeditateData val, _) =>
                                  val.val,
                              dataLabelMapper: (EmotionMeditateData data, _) =>
                                  data.label,
                              dataLabelSettings:
                                  DataLabelSettings(isVisible: true),
                              pointColorMapper: (EmotionMeditateData data, _) =>
                                  data.color,
                              enableTooltip: false)
                        ],
                        primaryXAxis: CategoryAxis(),
                        ...
                        series: <ChartSeries>[
                          ColumnSeries<EmotionIrritableData, String>(
                              ...
                              xValueMapper: (EmotionIrritableData val, _) =>
                                  val.continent,
                              yValueMapper: (EmotionIrritableData val, _) =>
                                  val.val,
                              dataLabelMapper: (EmotionIrritableData data, _) =>
                                  data.label,
                              dataLabelSettings:
                                  DataLabelSettings(isVisible: true),
                              pointColorMapper:
                                  (EmotionIrritableData data, _) => data.color,
                              enableTooltip: false)
                        ],
                        primaryXAxis: CategoryAxis(),
                        primaryYAxis: NumericAxis(
                      ...
                      SfCartesianChart(
                        ...
                        series: <ChartSeries>[
                          ColumnSeries<EmotionBoringData, String>(
                              ...
                              xValueMapper: (EmotionBoringData val, _) =>
                                  val.continent,
                              yValueMapper: (EmotionBoringData val, _) =>
                                  val.val,
                              dataLabelMapper: (EmotionBoringData data, _) =>
                                  data.label,
                              dataLabelSettings:
                                  DataLabelSettings(isVisible: true),
                              pointColorMapper: (EmotionBoringData data, _) =>
                                  data.color,
                              enableTooltip: false)
                        ],
                        primaryXAxis: CategoryAxis(),
                      ...
                      SfCartesianChart(
                        ...
                        series: <ChartSeries>[
                          ColumnSeries<EmotionAloneData, String>(
                              ...
                              xValueMapper: (EmotionAloneData val, _) =>
                                  val.continent,
                              yValueMapper: (EmotionAloneData val, _) =>
                                  val.val,
                              dataLabelMapper: (EmotionAloneData data, _) =>
                                  data.label,
                              dataLabelSettings:
                                  DataLabelSettings(isVisible: true),
                              pointColorMapper: (EmotionAloneData data, _) =>
                                  data.color,
                              enableTooltip: false)
                        ],
                        primaryXAxis: CategoryAxis(),
