        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              proFileShowDataPhoto(context, widget.patienData["Img"],
                  widget.patienData["Gender"]),
              Row(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 18)),
                              TextSpan(
                                  text: ' ${widget.patienData["Firstname"]}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 18)),
                              TextSpan(
                                  text: ' ${widget.patienData["Lastname"]}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text:
                                      ' ${DateThai(widget.patienData["Birthday"].toDate().toString())}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text:
                                      ' ${calAge(convertDateTimeDisplay(widget.patienData["Birthday"].toDate().toString()) + "ปี")}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 18)),
                              TextSpan(
                                  text: ' ${widget.patienData["Phonenumber"]}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 18)),
                              TextSpan(
                                  text: ' ${widget.patienData["Weight"]} กก.',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 18)),
                              TextSpan(
                                  text: ' ${widget.patienData["Height"]} ซม.',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text:
                                      ' ${widget.patienData["Waistline"]} นิ้ว',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 18)),
                              TextSpan(
                                  text: ' ${widget.patienData["Bloodgroup"]}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text:
                                      ' ${listNcds(widget.patienData["NCDs"])}',
                                  style: TextStyle(
                                    fontSize: 18,
                                  )),
                            ],
                          ...
                          child: Column(
                            children: [
                              ListTile(
                                ...
                                title: Text(
                                    "วันที่ทำการบันทึก : ${DateThai(document.id)}"),
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
