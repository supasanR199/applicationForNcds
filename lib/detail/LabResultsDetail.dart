                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing: Text("${labResultsData['Weight']} กก.",
                                style: TextStyle(
                                  fontSize: 17,
                                )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing: Text("${labResultsData['Height']} ซม.",
                                style: TextStyle(
                                  fontSize: 17,
                                )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing:
                                Text("${labResultsData["Waistline"]} นิ้ว",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing: Text("${labResultsData["Bmi"]}",
                                style: TextStyle(
                                  fontSize: 17,
                                )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing:
                                Text("${labResultsData["Pulse"]} ครั้ง/นาที",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing:
                                Text("${labResultsData["Breat"]} ครั้ง/นาที",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing:
                                Text("${labResultsData["BloodPressure"]} mmHg",
                                    style: TextStyle(
                                      fontSize: 17,
                                    )),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing: Text("${labResultsData["DTX"]} mg%",
                                style: TextStyle(
                                  fontSize: 17,
                                )),
                          ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["FBSFPG"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        leading: Column(
                          ...
                          children: [
                            ...
                            Text(
                                "(ค่าน้ำตาลที่สะสมอยู่ในเลือดในระยะเวลา 2-3 เดือน)"),
                          ],
                        ),
                        trailing: Text("${labResultsData["Hb1c"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["BUN"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Cr"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["LDL"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["HDL"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Chol"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Tg"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Microalbumin"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Uricacid"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Proteininurine"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text("${labResultsData["Eyetest"]}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing: Text(
                            "${DateThai(labResultsData["creatAt"].toDate().toString())}",
                            style: TextStyle(
                              fontSize: 17,
                            )),
                      ),
